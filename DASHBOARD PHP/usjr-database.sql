...
SELECT * FROM `programs` WHERE `progcollid` = 1; 
SELECT * FROM `programs` WHERE `progcollid` = 2; 
SELECT * FROM `programs` WHERE `progcollid` = 3; 
SELECT * FROM `programs` WHERE `progcollid` = 4;  -- For School of Education (SED)
SELECT * FROM `programs` WHERE `progcollid` = 5;  -- For School of Computer Studies (SCS)
SELECT * FROM `programs` WHERE `progcollid` = 6;  -- For School of Allied Medical Sciences (SAMS)
